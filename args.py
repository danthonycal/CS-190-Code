...
class Args(object):
	def __init__(self):
		...
		parser.add_argument("--weights", dest="weights", help="Weights file", default="yolov3.weights", type=str)
		parser.add_argument("--cfg", dest="cfg_file", help="Configuration file", default="yolov3.cfg", type=str)
		...
		parser.add_argument("--result_json", dest="res_json", help="processed result JSON from Darknet", type=str, default="./videos/frames/classified-json/1_GP007987_classified.json")
		parser.add_argument("--mode", dest="mode", help="-1 to process all videos, 0 to process specific video", type=int, default=0)
		
		args = parser.parse_args()
		self.weights	= args.weights
		self.config	 = args.cfg_file
